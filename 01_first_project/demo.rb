...
## 1- Para instalar a versão **6.1** do **Rails** abra seu terminal e execute o seguinte comando: gem install rails -v 6.1

## 2- Com a versão 6.1 instalada, crie o projeto com o seguinte comando: rails _6.1_ new biblioteca
...
## 3- Navegue até a pasta do projeto criado: cd biblioteca
...
## 5- Depois é necessário aplicar as mudanças ao Banco de Dados. Faça isso com o seguinte comando: #rails db:migrate

## 6- Agora levante o servidor com o comando: rails s
